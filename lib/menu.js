...
export const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Grok视频生成", command: "#gv [比例/尺寸] [480p|720p] [6秒|10秒] <提示词>", desc: "使用 Grok 文生视频或引用图生视频；比例支持 auto/16:9/9:16/1:1，也可传 854x480、480x854、480x480、1280x720、720x1280、720x720，默认 auto、720p、6 秒。", costCommand: charge("GrokVideo.generateVideo"), examples: ["#gv auto 720p 6秒 镜头推进的樱花街道", "#gv 9:16 480p 6秒 霓虹酒吧时装广告"] },
