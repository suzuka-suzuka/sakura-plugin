...
export const menuGroups = [
  {
    ...
    items: [
      { name: "AI聊天", command: "@机器人 / 角色前缀 + 内容", desc: "与配置的 AI 角色对话，支持上下文、工具和图片理解。", costCommand: charge("AIChat.Chat"), examples: ["小叶 今天有什么建议"] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "AI工具生图", command: "AI 调用 ImageGenerator 工具", desc: "对话中由 AI 主动调用的图片生成或改图工具。", costCommand: charge("EditImage.dispatchHandler") },
      { name: "AI工具绘图", command: "AI 调用 NAI 工具", desc: "对话中由 AI 主动调用的 NovelAI 绘图工具。", costCommand: charge("NaiPainting.naiParams") },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "伪人", command: "自动识别群聊触发", desc: "根据配置在群聊中触发伪人或拟态回复。", costCommand: charge("Mimic.Mimic"), trigger: "自动" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "AI经济工具", command: "AI 调用 Economy 工具", desc: "AI 可查询余额、转账或罚款。" },
    ],
  },
  {
