...
export const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Grok图片编辑", command: "#gi [比例] [n=1-6 / count=1-6] <提示词>", desc: "使用 Grok 文生图或引用图改图；支持 auto/16:9/9:16/3:2/2:3/1:1，默认 2:3、4 张，也可用 count= 指定张数。", costCommand: charge("GrokImage.editImage"), examples: ["#gi 16:9 n=4 赛博城市夜景", "#gi auto count=6 二次元头像"] },
      { name: "Grok视频生成", command: "#gv [r18] [比例/尺寸] [480p|720p] [6秒|10秒] <提示词>", desc: "使用 Grok 文生视频或引用图生视频；比例支持 auto/16:9/9:16/1:1，也可传 854x480、480x854、480x480、1280x720、720x1280、720x720，r18 使用 Grok Spicy 模式，默认 auto、720p、6 秒。", costCommand: charge("GrokVideo.generateVideo"), examples: ["#gv auto 720p 6秒 镜头推进的樱花街道", "#gv r18 9:16 480p 6秒 霓虹酒吧时装广告"] },
