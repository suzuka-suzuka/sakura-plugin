...
export const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Grok图片编辑", command: "#gi [比例] [pro|fast] [n=1-6 / count=1-6] <提示词>", desc: "使用 Grok 文生图或引用图改图；支持 auto/16:9/9:16/3:2/2:3/1:1，默认 2:3、4 张，也可用 count= 指定张数。", costCommand: charge("GrokImage.editImage"), examples: ["#gi 16:9 pro n=4 赛博城市夜景", "#gi auto count=6 二次元头像"] },
      { name: "Grok视频生成", command: "#gv [比例/尺寸] [720p|1080p] [6秒|10秒] <提示词>", desc: "使用 Grok 文生视频或引用图生视频；比例支持 auto/16:9/9:16/1:1，也可传 1280x720、720x1280、1920x1080、1080x1920、720x720、1080x1080，默认 auto、720p、6 秒。", costCommand: charge("GrokVideo.generateVideo"), examples: ["#gv auto 720p 6秒 镜头推进的樱花街道", "#gv 9:16 1080p 10秒 赛博少女转身"] },
