...
export class MemoryTool extends AbstractTool {
  name = "Memory";
  description = "主动记住关于当前对话用户的重要信息（偏好、习惯、设定、不喜欢的事等）。记忆会在下次对话开始时自动注入到你的设定中，让你始终记得这个人。请只记录真正值得长期保留的信息，避免记录临时或无意义的内容。";
  parameters = {
    properties: {
      content: {
        type: "string",
        description: "要记住的内容，用简洁的陈述句描述，例如：「该用户不喜欢你说废话」「该用户喜欢猫」",
      },
    },
    required: ["content"],
  };
